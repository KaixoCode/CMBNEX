...
namespace Kaixo
{
    ...
    public:
        ...
        Parameter* rphs = nullptr;
        Parameter* phse = nullptr; // Phase
        Parameter* sync = nullptr; // Sync
        Parameter* plsw = nullptr; // Pulse Width
        Parameter* wtps = nullptr; // WTP
        Parameter* bend = nullptr; // Bend
        Parameter* dcof = nullptr; // DC Offset

        Label* shpl = nullptr; // Shaper title
        Parameter* enbs = nullptr; // Enable Shaper
        Parameter* shpr = nullptr; // Shaper 1       
        Parameter* shpm = nullptr; // Shaper 1 Mix
        Parameter* shp2 = nullptr; // Shaper 2
        Parameter* sh2m = nullptr; // Shaper 2 Mix
        Parameter* shmr = nullptr; // Shaper morph

        Label* nsel = nullptr; // Noise title
        Parameter* enbn = nullptr; // Enable Noise
        Parameter* nois = nullptr; // Noise
        Parameter* nscl = nullptr; // Noise Color

        Label* fldl = nullptr; // Fold title
        Parameter* enbf = nullptr; // Enable fold
        Parameter* flda = nullptr; // Fold Amount
        Parameter* bias = nullptr; // Fold Bias

        Label* drvl = nullptr; // Drive title
        Parameter* enbd = nullptr; // Enable Drive
        Parameter* drvg = nullptr; // Drive Gain
        Parameter* drve = nullptr; // Drive amount
            ...
            : CViewContainer(size), index(index)
        {
            ...
            addView(v1); addView(v2); addView(v3); addView(v4); addView(v5); addView(v6); addView(v7);
    ...
    public:
        ...
        Parameter* enbl = nullptr; // Enable            
        Parameter* tune = nullptr; // Tune              
        Parameter* pann = nullptr; // Pos               
        Parameter* detn = nullptr; // Detune            
        Parameter* volm = nullptr; // Gain              
